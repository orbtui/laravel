<td {!! $classAttributes !!} {!! $alpineAttributes !!} {!! $livewireAttributes !!} {!! $styleAttributes !!} class="position-relative" x-init="$dispatch('uiHasTableActions')" x-data="{ open: false }" x-on:click.away="open = false">
