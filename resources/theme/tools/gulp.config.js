		...
		base: {
			src: {
				styles: [
                    ...
                    "{$config.path.src}/sass/fonts.scss"
                ],
				scripts: [
			...
			global: {
				src: {
					...
					optional: {
                        ...
                        "fontawesome-pro": {
                            styles: [
                                "{$config.path.common_src}/plugins/fontawesome-pro/css/all.min.css",
                            ],
                            fonts: [
                                "{$config.path.common_src}/plugins/fontawesome-pro/webfonts/**",
                            ],
                        },
					},
					override: {
				...
				dist: {
					styles: "{$config.dist}/css/plugins.bundle.css",
					scripts: "{$config.dist}/js/plugins.bundle.js",
					images: "{$config.dist}/images",
					fonts: "{$config.dist}/css/fonts",
				},
			},
			custom: {
				draggable: {
